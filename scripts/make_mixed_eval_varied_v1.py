...
def gen_B_cite(n):
    out = []
    topics = C_WRONG_TOPICS + [
        random_title() for _ in range(max(0, n - len(C_WRONG_TOPICS)))
    ]
...
def main():
    ...
    ap.add_argument(
        "--frac",
        type=str,
        default="A:0.35,Bc:0.25,Bm:0.25,C:0.15",
