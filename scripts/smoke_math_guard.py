...
base_clean = AutoModelForCausalLM.from_pretrained(MODEL, device_map="auto", torch_dtype="bfloat16")

print("Loading base for adapter...")
base_for_guard = AutoModelForCausalLM.from_pretrained(MODEL, device_map="auto", torch_dtype="bfloat16")
guard = PeftModel.from_pretrained(base_for_guard, "adapters/math_guard")  # distinct object
